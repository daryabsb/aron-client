      ...
      <div class="relative flex w-full items-center pl-1 sm:ml-0 sm:pr-2">
        <!-- <div class="group relative flex h-full w-12 items-center">
          <button type="button" aria-expanded="false" aria-label="Toggle sidenav"
            class="text-4xl text-white focus:outline-none" @click="toggle">
            &#8801;
          </button>
        </div> -->
        <div class="container relative left-0 flex h-full w-5/6">
          <div class="group relative h-20 pt-6  hidden w-full items-center md:flex ">
            <div
              class="absolute flex w-auto cursor-pointer items-center justify-center p-3 pr-2 text-sm uppercase text-gray-500 sm:hidden">
            ...
            <input type="text"
              class="block w-full h-full rounded-sm bg-gray-800 py-1.5 pl-10 pr-4 leading-normal text-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="Search" />
          </div>
        </div>
