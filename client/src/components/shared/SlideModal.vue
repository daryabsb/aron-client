<template>
  <TransitionRoot as="template" :show="open">
    <Dialog as="div" class="relative z-10" @close="toggleManagement">
        ...
        <div class="absolute inset-0 overflow-hidden">
          <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
            <TransitionChild as="template" enter="transform transition ease-in-out duration-500 sm:duration-700"
              ...
              <DialogPanel class="pointer-events-auto w-screen" :class="`max-w-${size}`">
                <div
                  class="flex h-full flex-col overflow-y-scroll bg-aronium-900 border-l border-aronium-500 py-6 shadow-xl">
                  <div class="px-4 sm:px-6">
                    <div class="flex items-start justify-between">
                      <DialogTitle class="text-lg font-medium text-aronium-white">
