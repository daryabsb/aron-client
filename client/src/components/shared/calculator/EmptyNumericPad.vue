<template>
  <Grid rows="4" cols="4" gap="2" class="w-full sm:max-w-md sm:h-auto sm:my-3 p-3 bg-inherit">
    ...
    <Button v-for="number in ['1', '2', '3']" :key="number" variant="transparent">{{ " " }}
    </Button>
    <Button variant="transYellow"></Button>

    <Button v-for="number in ['4', '5', '6']" :key="number" variant="transparent">
    </Button>
    <Button variant="transRed"></Button>

    <Button v-for="number in ['7', '8', '9']" :key="number" variant="transparent">
    </Button>
    <Button variant="transparent" class="row-start-3 col-start-4 inset-0 col-span-1 row-span-2"></Button>
    <Button variant="transparent" class="col-span-2"></Button>
